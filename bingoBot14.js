...
document.getElementById("10A").innerHTML = document.getElementById('text10').value;
document.getElementById("11A").innerHTML = document.getElementById('text11').value;
document.getElementById("12A").innerHTML = document.getElementById('text12').value;
document.getElementById("13A").innerHTML = document.getElementById('text13').value;
document.getElementById("14A").innerHTML = document.getElementById('text14').value;
document.getElementById("15A").innerHTML = document.getElementById('text15').value;
document.getElementById("16A").innerHTML = document.getElementById('text16').value;
}
...
document.getElementById("10A").onclick = function(){
  document.getElementById("10A").style.backgroundColor  = 'green';
  document.getElementById("10A").style.color  = 'green';
  ultimateCheck();
}

document.getElementById("11A").onclick = function(){
  document.getElementById("11A").style.backgroundColor  = 'green';
  document.getElementById("11A").style.color  = 'green';
  ultimateCheck();
}

document.getElementById("12A").onclick = function(){
  document.getElementById("12A").style.backgroundColor  = 'green';
  document.getElementById("12A").style.color  = 'green';
  ultimateCheck();
}

document.getElementById("13A").onclick = function(){
  document.getElementById("13A").style.backgroundColor  = 'green';
  document.getElementById("13A").style.color  = 'green';
  ultimateCheck();
}


document.getElementById("14A").onclick = function(){
  document.getElementById("14A").style.backgroundColor  = 'green';
  document.getElementById("14A").style.color  = 'green';
  ultimateCheck();
}

document.getElementById("15A").onclick = function(){
  document.getElementById("15A").style.backgroundColor  = 'green';
  document.getElementById("15A").style.color  = 'green';
  ultimateCheck();
}

document.getElementById("16A").onclick = function(){
  document.getElementById("16A").style.backgroundColor  = 'green';
  document.getElementById("16A").style.color  = 'green';
  ultimateCheck();
}
function check1(){
  var i = 0;
...
function showInputs(){
    ...
    showMakeBtn();
		...
		alert ('Sorry you can only make a bingo card with 1-14 assignments')
	}
}
