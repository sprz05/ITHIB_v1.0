...
function start1st(){
  ...
  document.getElementById("timerDoneDiv").style.display = "none";
...
function end1st() {
  ...
  document.getElementById("breakTimersDiv").style.display = "block";//shows break time options 
  ...
  function start5Timer1() {
    ...
    function start30Break1() {
      ...
      function show5BreakTimer(){  
        document.getElementById("breakTimersDiv").style.display = "none";
